...
/***/ "./assets/src/scripts/Admins/gallery.js":
/*!**********************************************!*\
  !*** ./assets/src/scripts/Admins/gallery.js ***!
  \**********************************************/
...
var GalleryElement = /*#__PURE__*/function () {
      ...
      (function ($) {
        ...
        $('body').on('click', '.btn-media-uploader', function (e) {
          ...
          var field = $(this).data('media-uploader-target'),
              fieldId = $(this).data('media-uploader-id'); // Sets up the media library frame
        ...
        $('.btn-meta-gallery').click(function (e) {
          ...
          var target = $(this).data('media-gallery-target'),
              nameAttr = $(this).data('media-gallery-name'),
              $target = $(target); //create a new Library, base on defaults
          ...
          var metaGalleryFrame = wp.media.frames.metaGalleryFrame = wp.media({
            title: meta_image.title,
            button: {
              text: 'Use this file'
            },
          ...
          metaGalleryFrame.on('select', function () {
            var state = metaGalleryFrame.state('insert-image');
            ...
            selection.each(function (attachment) {
              ...
              var caption = obj_attachment.caption,
                  options,
                  html; // If captions are disabled, clear the caption.
              ...
              attachment.attributes['post_id'] = wp.media.view.settings.post.id; //do what ever you like to use it
              // console.log( target );
          ...
          metaGalleryFrame.on('open', function () {
            var selection = metaGalleryFrame.state('insert-image').get('selection'); //remove all the selection first
...
var galleryElement = new GalleryElement();
...
/***/ "./assets/src/scripts/Admins/switch.js":
/*!*********************************************!*\
  !*** ./assets/src/scripts/Admins/switch.js ***!
  \*********************************************/
/*! exports provided: default */
...
var SwitchElement = /*#__PURE__*/function () {
      ...
      (function ($) {
        $(document).ready(function () {
          $('body').on('click', '.field-switch .button-secondary', function (e) {
            ...
            var checkBox = $(this).parents('.field-switch').find('input');
...
var switchEl = new SwitchElement();
/* harmony default export */ __webpack_exports__["default"] = ({
  switchEl: switchEl
});
...
/* harmony import */ var _Admins_switch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Admins/switch */ "./assets/src/scripts/Admins/switch.js");
/* harmony import */ var _Admins_gallery__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Admins/gallery */ "./assets/src/scripts/Admins/gallery.js");
// Sweet Alert 2

window.Swal = sweetalert2__WEBPACK_IMPORTED_MODULE_0___default.a; // Custom Elements
...
module.exports = __webpack_require__(/*! /Volumes/Data/Programming/Web/wedangpress/wp-content/themes/batik/assets/src/scripts/admin.js */"./assets/src/scripts/admin.js");
